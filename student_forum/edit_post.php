		...
		<div class="content"><!-- content starts-->
			...
			<div id="content_timeline"><!-- content_timeline starts-->
				...
				<form action="" method="post" id="f" enctype="multipart/form-data"  >
					...
					<textarea cols="73" rows="4" name="content" ><?php echo $post_con; ?></textarea><br/>
				 ...
				 <?php
				 		if(isset($_POST['update'])){
				 			...
				 			$update_post = "update posts set post_title='$title', post_content='$content', topic_id='$topic', post_image='$p_image' where post_id='$get_id'";
				 			...
				 			{
				 				echo "<script>alert('Post has been not update!')</script>";
