			...
			<div id="content_timeline"><!-- content_timeline starts-->
				...
				<div id="msg" class="animated bounceInRight"><!-- msg starts-->
					...
					<table width="700" align="center">
						...
						<tr align="center">
							<td colspan="4"><h2>See sent your messages:</h2> </td>
						</tr>
					...
					?>
						...
						<tr align="center">
							...
							<td>
								<a href="sent.php?msg_id=<?php echo $msg_id;?>"><?php echo $msg_sub;?>
								</a>
							</td>
							<td><?php echo $msg_date;?></td>
							<td><a href="delete_sent.php?msg_id=<?php echo $msg_id;?>"> Delete </a></td>
