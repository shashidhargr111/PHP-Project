								...
								<form id="login-form" role="form" autocomplete="off" class="form" method="post">
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input name="user_num" type="text" class="form-control" placeholder="Enter User Number">
										</div>
									</div>
	...
	<?php
          ...
          if(!isset($_SESSION)) 
			...
			if(isset($_POST['login'])){
				...
				$get_user = "select * from seller_user where sl_mobile_no='$email' AND sl_pass='$pass'";
				...
				$get_user_v = "select * from seller_user where sl_mobile_no='$email' AND sl_status='verified'";
